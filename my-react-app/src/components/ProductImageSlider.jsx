...
function ImageSlider({ itemID }) {
  ...
  return (
    <>
      {error ? (
        <div className="w-full h-full border-[2px] border-slate-400 text-center">not found images</div>
      ) : (
        <div className="w-full h-full bg-center overflow-hidden  relative group">
          <div className="rounded-2xl bg-center duration-500 ">
